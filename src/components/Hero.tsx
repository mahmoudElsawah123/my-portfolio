        ...
        <div ref={textRef} className="text-center max-w-4xl mx-auto">
          ...
          <div className="hero-text flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button
              ...
              className="btn-glow"
              onClick={() =>
                (window.location.href = "mailto:mahmooudelsawah21@gmail.com")
              }
            >
            ...
            <div className="flex gap-4">
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://wa.me/201007296138?text=Hello%20Mahmoud",
                    "_blank"
                  )
                }
              >
              ...
              <Button
                ...
                className="glass"
                onClick={() =>
                  window.open("https://github.com/mahmoudElsawah123", "_blank")
                }
              >
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/mahmoud-elsawah-198413219",
                    "_blank"
                  )
                }
              >
