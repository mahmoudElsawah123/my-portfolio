...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "mahmoudelsawah21@gmail.com",
    href: "mailto:mahmoudelsawah21@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
  ...
  },
  {
    icon: MapPin,
    label: "Location",
    value: "El Mahalla El Kobra, Egypt",
    href: "#",
  },
];
...
const socialLinks = [
  ...
  {
    icon: Linkedin,
    href: "https://www.linkedin.com/in/mahmoud-elsawah-198413219",
    label: "LinkedIn",
  },
  {
    icon: Facebook,
    href: "https://web.facebook.com/mahmoud.elsawah.718/",
    label: "Facebook",
  },
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-20 relative">
      <div className="container mx-auto px-6">
        <motion.a
          href="mailto:mahmooudelsawah21@gmail.com"
        ...
        >
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto">
            ...
            bring your ideas to life. I'm always excited to take on new
            challenges.
          </p>
        </motion.a>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  placeholder="elsawah@example.com"
                  required
                  className="bg-background-secondary border-card-border"
                />
              </div>
